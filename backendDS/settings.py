"""
Django settings for backendDS project.
...
SECRET_KEY = 'django-insecure-hiwz@m-d#=yu7_occ*du7g$=#s8elwa^=)cohl0e2rhf_l^!c1'
...
WSGI_APPLICATION = 'backendDS.wsgi.application'
